...
class Cpiwm_Export_Content {
	...
	public static function execute( $params ) {
		...
		// Set progress
		Cpiwm_Status::info( sprintf( __( 'Archiving %d files...<br />%d%% complete', CPIWM_PLUGIN_NAME ), $total_files_count, $progress ) );
		...
		// Get map file
		$filemap = cpiwm_open( cpiwm_filemap_path( $params ), 'r' );
