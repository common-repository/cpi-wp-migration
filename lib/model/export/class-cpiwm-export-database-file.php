...
class Cpiwm_Export_Database_File {
	...
	public static function execute( $params ) {
		...
		if ( isset( $params['total_database_size'] ) ) {
			...
			$total_database_size = cpiwm_database_bytes( $params );
		}
		...
		// Set progress
		Cpiwm_Status::info( sprintf( __( 'Archiving database...<br />%d%% complete', CPIWM_PLUGIN_NAME ), $progress ) );
		...
		if ( $archive->add_file( cpiwm_database_path( $params ), CPIWM_DATABASE_NAME, $database_bytes_written, $database_bytes_offset ) ) {

			// Set progress
			Cpiwm_Status::info( __( 'Done archiving database.', CPIWM_PLUGIN_NAME ) );
